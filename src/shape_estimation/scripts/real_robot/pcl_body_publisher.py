...
def on_new_point_cloud(data):
    ...
    # tmp1 = (0.2 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.85) & (-0.25 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.4) & (0.11 < p[:,2]) & (p[:,2] < 0.3)

    tmp1 = (0.2 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.85) & (-0.26 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < -0.05) & (0.14 < p[:,2]) & (p[:,2] < 0.3) 
    tmp2 = (0.2 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.87) & (-0.28 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.25) & (0.135 < p[:,2]) & (p[:,2] < 0.3)


    # tmp1 = (0.2 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.85) & (-0.25 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.05) & (0.11 < p[:,2]) & (p[:,2] < 0.25) # body
    # tmp1 = (0.2 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.85) & (0.05 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.3) & (0.11 < p[:,2]) & (p[:,2] < 0.25) # head
...
def callback(data):
    ...
    print "-----publish pcl-----"
    pcl2 = pcl2.voxel_down_sample(voxel_size = 0.01)
    publish_pointcloud(pcl2, data)

    pcl1 = pcl1.voxel_down_sample(voxel_size = 0.07)
...
#     # 似ていない
#     # tmp1 = (0.1 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.6 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0) & (0.1 < p[:,2]) & (p[:,2] < 0.26)
#     # tmp2 = (0.1 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.6 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.3) & (0.1 < p[:,2]) & (p[:,2] < 0.26)

#     # arm
#     tmp1 = (0.5 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.25 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.2) & (0.16 < p[:,2]) & (p[:,2] < 0.2)
#     tmp2 = (0.5 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.3 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.4) & (0.15 < p[:,2]) & (p[:,2] < 0.2)

#     # tmp1 = (0.4 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.2 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.2) & (0.14 < p[:,2]) & (p[:,2] < 0.2)
#     # tmp2 = (0.45 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.8) & (-0.3 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.4) & (0.14 < p[:,2]) & (p[:,2] < 0.2)
...
#     pcl1 = pcl1.voxel_down_sample(voxel_size = 0.03)
#     publish_pointcloud2(pcl1, data)
