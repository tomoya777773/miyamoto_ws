...
def on_new_point_cloud(data):
    ...
    # arm
    tmp1 = (0.45 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.9) & (-0.25 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.2) & (0.15 < p[:,2]) & (p[:,2] < 0.2)
    tmp2 = (0.45 < p[:,0] + p[:,1]) & (p[:,0] + p[:,1] < 0.9) & (-0.25 < p[:,1] - p[:,0]) & (p[:,1] - p[:,0] < 0.5) & (0.14 < p[:,2]) & (p[:,2] < 0.25)
...
def callback(data):
    ...
    pcl1 = pcl1.voxel_down_sample(voxel_size = 0.04)
